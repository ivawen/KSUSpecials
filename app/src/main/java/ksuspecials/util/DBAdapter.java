...
public class DBAdapter extends SQLiteOpenHelper {
	private static String DB_PATH = "https://www.000webhost.com/members/website/ksuspecials/database";

	private static String DB_NAME = "id3356126_ksuspecials";

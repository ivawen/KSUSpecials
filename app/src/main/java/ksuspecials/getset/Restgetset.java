...
public class Restgetset {
	String id, name, address, latitude, longitude, ratting, zipcode, vegtype,
			thubnailimage, foodtype, time, phone_no, thumimage, images, title,
			image, video, email, totalreview,distance;
